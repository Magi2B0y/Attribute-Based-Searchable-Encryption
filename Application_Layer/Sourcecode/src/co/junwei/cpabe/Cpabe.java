...
public class Cpabe {
	...
	public byte[] enc(String pubfile, String policy, String AESkey,
...
//		 PrintArr("element: ", m.toBytes());
		...
		byte[] Enckey = Common.suckFile(encfile);
	...
	public byte[] dec(String pubfile, String prvfile, byte[] Enckey) throws Exception {
		byte[] aesBuf, cphBuf;
		byte[] plt = null;
		byte[] prv_byte;
		byte[] pub_byte;
		...
		/* read ciphertext */
		String encfile = "./SerializedData/cpabe/enc_AESkey.ser";

...
public abstract class AbstractElement implements Element, Serializable {
    ...
    protected AbstractField abstractField;
    protected boolean immutable = false;


    public AbstractElement(Field field) {
        this.abstractField = (AbstractField) field;
    }
    ...
    public int getLengthInBytes() {
        return abstractField.getLengthInBytes();
    }
    ...
    public Element halve() {
        return mul(abstractField.newElement().set(2).invert());
    }
    ...
    public Element mul(int z) {
        mul(abstractField.newElement().set(z));
    ...
    protected List<Element> buildPowWindow(int k) {
        ...
        lookup.add(abstractField.newOneElement());
    ...
    protected void elementPowWind(BigInteger n) {
        ...
        Element result = abstractField.newElement().setToOne();

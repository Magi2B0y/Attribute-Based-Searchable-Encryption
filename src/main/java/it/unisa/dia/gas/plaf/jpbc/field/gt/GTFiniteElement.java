 ...
 */
public class GTFiniteElement extends AbstractElement implements Serializable {
    ...
    public GTFiniteElement duplicate() {
        return new GTFiniteElement(pairing, (GTFiniteField) abstractField, value.duplicate());
    }
    ...
    public GTFiniteField getField() {
        return (GTFiniteField) abstractField;
    }
